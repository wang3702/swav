...
command_line = "python -u main_swav.py --data_path imagenet --nmb_crops 2 6 --size_crops 224 96 " \
               ...
               "--nmb_prototypes 3000 --queue_length 3840  --epoch_queue_starts 15  --epochs 100 --batch_size 64 " \
               "--base_lr 1.2 --final_lr 0.0012 --freeze_prototypes_niters 5005  --wd 0.000001 --warmup_epochs 0  " \
               "--dist_url=tcp://localhost:10031 --arch resnet50 --use_fp16 true  --sync_bn pytorch --dump_path %s"%dump_path
